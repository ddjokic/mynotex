...
begin
  // Save changes to current subject
  if fmMain.dsSubjects.State in [dsEdit] then
  begin
...
begin
  // Cancel on exit possibile changes not saved
  if fmMain.dsSubjects.State in [dsEdit] then
